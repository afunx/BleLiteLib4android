...
public interface BleOperation extends Runnable{
    ...
    long BLE_DISCOVER_SERVICE_SUC = 0x0006;
    long BLE_DISCOVER_SERVICE_TIMEOUT = 0x0007;
    long BLE_DISCOVER_CHARACTERISTIC_SUC = 0x0008;
    long BLE_DISCOVER_CHARACTERISTIC_TIMEOUT = 0x0009;
